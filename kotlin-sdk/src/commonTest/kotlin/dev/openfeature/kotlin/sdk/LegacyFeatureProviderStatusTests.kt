    ...
    fun legacy_shutdown_tryEmit_last_event_visible_on_shared_observe_before_swap_completes() = runTest {
        ...
        waitAssert {
            assertTrue(
                ...
                "inner.observe() should deliver ProviderStale from shutdown() while adapter collect is still active; got $seen"
            )
        }
        ...
        assertTrue(
            ...
            "tryEmit(ProviderStale) in inner.shutdown() should succeed (non-empty subscribers + buffer for shutdown-time emit)"
        )
    }
